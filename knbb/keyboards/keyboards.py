...
button_4: KeyboardButton = KeyboardButton(text=LEXICON_RU['pencil'])
button_5: KeyboardButton = KeyboardButton(text=LEXICON_RU['ogon'])
button_6: KeyboardButton = KeyboardButton(text=LEXICON_RU['water'])
