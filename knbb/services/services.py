...
def get_bot_choice() -> str:
    return random.choice(['rock', 'paper', 'scissors', 'pencil', 'ogon', 'water'])
...
def get_winner(user_choice: str, bot_choice: str) -> str:
    ...
    rules: dict[str, str] = {'rock': ['scissors', 'pencil', 'ogon'],
                             'scissors': ['paper', 'pencil'],
                             'paper': ['rock', 'pencil', 'water'],
                             'pencil': 'water',
                             'ogon': ['pencil', 'paper', 'pencil'],
                             'water': ['ogon', 'rock', 'scissors']}
